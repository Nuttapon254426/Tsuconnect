                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">คุณกำลังมองหาฟรีแลนซ์อยู่ใช่ไหม?</h1>

                            <h6 class="text-center text-white">TSU Freelancer Connect ช่วยให้คุณเชื่อต่อนิสิตฟรีแลนซ์ที่มีทักษะได้ทันที</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4 mb-lg-0">
                        ...
                        <p class="text-white d-flex">
                            <a href="sci.tsu.ac.th" class="site-footer-link">
                            sci.tsu.ac.th
                            </a>
                        </p>
                    </div>
