...
<body id="top">
    ...
    <div>
            ...
            if ($userRole === 'freelance') {
                include "navbar.php"; // Include the navbar for freelance users
            } elseif ($userRole === 'member') {
                include "membernav.php"; // Include the membernav for member users
            }
            ?>
        </div>
        <style>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $details_link = 'details.php?id=' . $row['job_id']; // แทนที่ 'details.php' ด้วย URL จริงๆ
